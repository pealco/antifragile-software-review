...
- `scripts/antifragile_scan.py`: a dependency-free Python scanner that surfaces review leads such as swallowed errors, fixed sleeps, destructive commands, process aborts, hard-coded endpoints, missing cancellation, operational term coverage, skipped files, and capped-result overflow.
